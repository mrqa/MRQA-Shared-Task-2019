...
wget https://s3.us-east-2.amazonaws.com/mrqa/release/train/TriviaQA-unfilt.jsonl.gz -O $OUTPUT/TriviaQA-unfilt.jsonl.gz
wget https://s3.us-east-2.amazonaws.com/mrqa/release/train/TriviaQA-web.jsonl.gz -O $OUTPUT/TriviaQA-web.jsonl.gz
